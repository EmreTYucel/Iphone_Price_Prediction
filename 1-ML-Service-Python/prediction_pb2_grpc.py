...
class PricePredictorStub(object):
    """Bu servis ismi Python tarafındaki sınıf ismini (PricePredictorServicer) belirler.
    """
...
def add_PricePredictorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'PricePredictor', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('PricePredictor', rpc_method_handlers)
